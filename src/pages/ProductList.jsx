  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <EditModal
        ...
        description={modal?.product ? `${modal.product.name} - currently ${modal.product.quantity.toString()}` : ''}
      ...
      <EditModal
        ...
        onClose={() => setModal(null)}
        title="Update Price"
        description={modal?.product ? `${modal.product.name} - currently ${modal.product.price.toString()}` : ''}
